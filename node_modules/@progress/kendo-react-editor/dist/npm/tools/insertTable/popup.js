...
exports.InsertTablePopupNS = void 0;
...
(function (InsertTablePopupNS) {
    ...
    var InsertTablePopup = /** @class */ (function (_super) {
        ...
        InsertTablePopup.prototype.render = function () {
            ...
            return (React.createElement(kendo_react_popup_1.Popup, { anchor: anchor, anchorAlign: { horizontal: horizontal, vertical: 'bottom' }, popupAlign: { horizontal: horizontal, vertical: 'top' }, popupClass: "k-ct-popup k-group k-reset k-state-border-up", show: show, style: dir === 'rtl' ? { direction: 'rtl' } : undefined },
                React.createElement(popupGrid_1.default, { rows: rows, columns: columns, createTableMessage: this.props.createTableMessage, createTableHintMessage: this.props.createTableHintMessage, onCellClick: this.props.onTableInsert, onDown: this.onPointerDown })));
        };
        /**
         * @hidden
         */
...
})(InsertTablePopupNS = exports.InsertTablePopupNS || (exports.InsertTablePopupNS = {}));
